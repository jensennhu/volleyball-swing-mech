...
SPIKE_METADATA_PATH = "data/processed/pose_sequences/frames_downsampled_multi/spike_sequences_metadata.json"  # Spike metadata
POSE_TYPE = "auto"                      # "auto", "mediapipe", or "yolo"
OUTPUT_DIR = "models"              # Where to save trained models
MODEL_NAME = "model_20260120"   # Model name prefix
